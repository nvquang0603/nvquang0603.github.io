<?php 
	...
	$regExName = '/^[a-zA-ZđàáảãạăắẳặâấậèéẻẽẹêềếểễệìíỉĩịòóỏõọôồốổỗộơờớởỡợùúủũụỳýỷỹỵĐÀÁẢÃẠĂẮẶẲÂẦẤẨẪẬÈÉẺẼẸÊỀẾỂỄỆÌÍỈĨỊÒÓỎÕỌÔỒỐỔỖỘƠỜỚỞỠỢÙÚỦŨỤỲÝỶỸỴ ]+$/u';
	$regExAddress = '/^[a-zA-ZđàáảãạăắẳặâấậèéẻẽẹêềếểễệìíỉĩịòóỏõọôồốổỗộơờớởỡợùúủũụỳýỷỹỵĐÀÁẢÃẠĂẮẶẲÂẦẤẨẪẬÈÉẺẼẸÊỀẾỂỄỆÌÍỈĨỊÒÓỎÕỌÔỒỐỔỖỘƠỜỚỞỠỢÙÚỦŨỤỲÝỶỸỴ ]+$/u';
