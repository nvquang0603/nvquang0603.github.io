	...
	<div class="container">
		...
		<div class="row product-row">
			...
			foreach ($relateProduct as $relateProduct) {
				...
				<div class="col">
					<div class="card">
						<a href="<?= $siteUrl?>product_detail.php?id=<?= $relateProduct['id']?>"><?php inOutStock($relateProduct['status']) ?></a>
						<a href="<?= $siteUrl?>product_detail.php?id=<?= $relateProduct['id']?>"><img class="card-img-top" src="<?php echo $relateProduct['image']?>" alt="Card image cap"></a>
						<div class="card-body">
